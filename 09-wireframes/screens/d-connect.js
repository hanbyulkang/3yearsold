...
S.push({
  ...
  notes: [
    ...
    '보호견 데이터는 서울 vPetInfo 공공 API 동기화(§6.4, D-019) — 보호소 입력 없음. 개별 조회 API가 없어 CRON 스냅샷 필수.',
...
S.push({
  ...
  notes: [
    ...
    '임시보호 신청 가능 여부는 vPetInfo의 FOSTER_STATUS로 판정(D-019) — 값이 "임시보호가능"이 아니면 임보 CTA를 노출하지 않는다.',
