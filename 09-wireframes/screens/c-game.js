/* C. 미니게임 — 발바닥 소모 · 뼈다귀 획득 (PRD §4.2, §5) */
(function (S) {
...
S.push({
  ...
  html: `
    ...
    <div class="appbar"><span class="t">미니게임</span><div class="hud"><span class="cur">🐾 3/5</span><span class="cur">🦴 12,400</span></div></div>
    <div class="body">
      ...
      <div class="card">
        <div class="row top">
          ...
          <div class="grow col" style="gap:3px">
            ...
            <div class="s">간식을 3개씩 맞춰요 · 클리어 시 최대 300 🦴</div>
          </div>
        </div>
...
S.push({
  ...
  `,
  notes: [
    '시간 제한 없음 — 이동 수 제한만(§1.2 원칙 2). 목표 미달도 점수 비례 뼈다귀 지급, "지는 판" 없음.',
  ...
  html: `
    ...
    <div class="body" style="justify-content:center;gap:14px">
      ...
      <div class="card center">
        <div class="h2 mono">+280 🦴</div>
        <div class="s">보유 뼈다귀 12,680 🦴</div>
      </div>
      <div class="aibox">
        <div class="cap">단추</div>
        <div class="s">(신나서 폴짝폴짝) 이 뼈다귀로 보호소 친구들 사료를 채워줄 수 있대요!</div>
      </div>
    </div>
    <div class="footer">
...
S.push({
  ...
  prd: '§5.2',
  title: '발바닥 부족 (충전 시트)',
  purpose: '시간 회복 대기 or 육포 충전. 뼈다귀 충전은 없다.',
  html: `
    <div class="sb"><span>9:41</span><span></span><span>100%</span></div>
    <div class="body pad0">
    ...
    <div class="overlay">
      <div class="sheet">
        ...
        <div class="xs">발바닥은 시간이 지나면 자동으로 회복돼요. 뼈다귀로는 충전할 수 없어요.</div>
      </div>
    </div>
  `,
  notes: [
    '뼈다귀→발바닥 차단은 §5.2 확정(무한 인플레 루프 방지). 우회 UI 만들지 말 것.',
...
S.push({
  ...
  html: `
    ...
    <div class="body">
      ...
      <div class="s">이번 주 1위는 이번 기부 증서에 이름이 올라가요. 랭킹 점수는 플레이·돌봄으로 얻은 뼈다귀만 집계합니다 — 결제로 전환한 뼈다귀는 포함되지 않아요.</div>
    </div>
  `,
  notes: [
